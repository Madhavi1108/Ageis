"""Parse a pytest JUnit-XML report into per-test outcomes. See
docs/EXECUTION_MODEL.md Section 4 step 7. Ported from
backend/aegis/sandbox/result_parser.py.
"""
...
from app.schemas.execution import TestOutcome
